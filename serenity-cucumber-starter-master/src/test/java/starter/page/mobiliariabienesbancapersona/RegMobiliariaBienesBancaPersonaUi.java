package starter.page.mobiliariabienesbancapersona;
...
public class RegMobiliariaBienesBancaPersonaUi extends PageObject {
    //TAB: Datos Generales
    ...
    public static Target TXT_FECRECFILE = Target.the("TextBox Fecha de Recepción de File")
            .located(By.id("ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_txtFecRecepcion"));

    public static Target TXT_FECPREINSCRIPCION = Target.the("TextBox Fecha Preinscripción")
            .located(By.id("ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_txtFechaPreIns"));
    ...
    public static Target TXT_NROCREDITO = Target.the("Nro de Crédito")
    ...
    public static Target TXT_IMPPOLEXT = Target.the("Importe Según Póliza Externa")
            .located(By.id("ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_tztImpPolizaExterna"));
