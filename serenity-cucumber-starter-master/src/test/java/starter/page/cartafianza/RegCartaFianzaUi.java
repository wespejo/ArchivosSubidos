package starter.page.cartafianza;
...
public class RegCartaFianzaUi extends PageObject {
    //TAB: Datos Generales
    ...
    public static Target LBL_TDOCU = Target.the( "Listado de Tipos de Documento")
            .located(By.xpath("//*[@id=\"ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_ddlTipoDocumento\"]"));

    public static Target LBL_MONEDA = Target.the("Moneda de Garantía")
    ...
    public static Target TXT_NDIAS = Target.the("TextBox Número de Días")
            .located(By.xpath("//*[@id=\"ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_txtDias\"]"));
    ...
    public static Target TXT_PORCENTAJE = Target.the("Porcentaje")
            .located(By.xpath("//*[@id=\"ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_txtPorcentaje\"]"));

    public static Target TXT_IMPORTE = Target.the("Importe")
            .located(By.xpath("//*[@id=\"ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_txtImporte\"]"));
    ...
    public static Target CBO_CATBANCO = Target.the("Categoria del banco")
            .located(By.id("ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_cboCatBancos"));

    public static Target CBO_BANCO = Target.the("Banco")
            .located(By.id("ctl00_cphPrincipal_tabGarantias_tabDatosGarantias_cboBancos"));

    public static Target LBL_LINEABANCO = Target.the("Líneas Asoc. Al Banco/Convenio")
