...
public class GACMenuPrincipalStepDefinitions {
    @Y("se selecciona tipo de Garantia Hipoteca Banca Persona")
    public void se_selecciona_tipo_de_Garantia_Hipoteca_Banca_Persona() throws InterruptedException {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                SelectFromOptions.byIndex(20).from(GACMenuPrincipalUi.SEL_TIP_GARANTIA),
