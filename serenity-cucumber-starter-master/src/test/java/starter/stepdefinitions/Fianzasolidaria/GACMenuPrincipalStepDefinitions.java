...
public class GACMenuPrincipalStepDefinitions {
    ...
    public void se_selecciona_tipo_de_garantía_Fianza_Solidaria() throws InterruptedException {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                SelectFromOptions.byIndex(9).from(GACMenuPrincipalUi.SEL_TIP_GARANTIA),
