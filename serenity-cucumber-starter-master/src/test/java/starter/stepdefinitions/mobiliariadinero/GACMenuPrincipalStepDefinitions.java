...
public class GACMenuPrincipalStepDefinitions {
    ...
    public void se_selecciona_tipo_de_garantia_mobiliaria_sobre_dinero() throws InterruptedException {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                SelectFromOptions.byIndex(15).from(GACMenuPrincipalUi.SEL_TIP_GARANTIA),
