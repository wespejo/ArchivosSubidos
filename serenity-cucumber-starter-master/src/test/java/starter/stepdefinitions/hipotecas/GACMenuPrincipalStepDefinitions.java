...
public class GACMenuPrincipalStepDefinitions {
    ...
    public void se_selecciona_tipo_de_garantia_hipotecas() throws InterruptedException {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                SelectFromOptions.byVisibleText("Hipotecas").from(GACMenuPrincipalUi.SEL_TIP_GARANTIA),
