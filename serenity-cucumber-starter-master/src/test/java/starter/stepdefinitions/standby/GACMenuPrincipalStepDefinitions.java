...
public class GACMenuPrincipalStepDefinitions {
    ...
    public void se_selecciona_tipo_de_Garantia_Stand_By() throws InterruptedException {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                SelectFromOptions.byVisibleText("Stand By").from(GACMenuPrincipalUi.SEL_TIP_GARANTIA),
